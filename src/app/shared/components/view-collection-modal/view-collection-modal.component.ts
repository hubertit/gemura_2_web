...
import { Collection } from '../../../features/collections/collection.model';
          ...
          <div class="collection-info">
            <div class="info-row">
              <div class="info-label">
                <app-lucide-icon name="truck" size="16px"></app-lucide-icon>
                Supplier
              </div>
              <div class="info-value">{{ collection.supplierName }}</div>
            </div>
            ...
            <div class="info-row">
              ...
              <div class="info-value">{{ collection.supplierPhone }}</div>
            </div>
            ...
            <div class="info-row">
              ...
              <div class="info-value">{{ collection.quantity }} L</div>
            </div>
            ...
            <div class="info-row">
              ...
              <div class="info-value">{{ formatCurrency(collection.pricePerLiter) }}</div>
            </div>
            ...
            <div class="info-row">
              ...
              <div class="info-value total">{{ formatCurrency(collection.totalValue) }}</div>
            </div>

            <div class="info-row" *ngIf="collection.quality">
              <div class="info-label">
                <app-lucide-icon name="check-circle" size="16px"></app-lucide-icon>
                Quality
              </div>
              <div class="info-value">{{ collection.quality }}</div>
            </div>
            ...
            <div class="info-row">
              ...
              <div class="info-value">{{ formatDate(collection.collectionDate) }}</div>
            </div>
            ...
            <div class="info-row" *ngIf="collection.rejectionReason">
              <div class="info-label">
                <app-lucide-icon name="alert-circle" size="16px"></app-lucide-icon>
                Rejection Reason
              </div>
              <div class="info-value rejection">{{ collection.rejectionReason }}</div>
            </div>

            <div class="info-row" *ngIf="collection.notes">
              <div class="info-label">
                <app-lucide-icon name="file-text" size="16px"></app-lucide-icon>
                Notes
              </div>
              <div class="info-value">{{ collection.notes }}</div>
            </div>
          </div>
        </div>
...
export class ViewCollectionModalComponent {
  ...
  @Output() approveRequested = new EventEmitter<Collection>();
  @Output() rejectRequested = new EventEmitter<Collection>();
  ...
  onApprove() {
    this.approveRequested.emit(this.collection);
  }

  onReject() {
    this.rejectRequested.emit(this.collection);
  }
